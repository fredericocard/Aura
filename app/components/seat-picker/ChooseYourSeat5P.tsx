...
/**
 * Aura — "Choose your seat" modal · 5-PLAYER POD (compass style)
 * Seat ids: 'a' (top-left), 'b' (bottom-left), 'c' (top-right),
 *           'd' (bottom-right), 'e' (bottom).
 */
...
export default function ChooseYourSeat5P({
  claimed = {},
  onClaim,
  justClaimedId = null,
  you,
