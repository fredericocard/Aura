...
export default function GridView5P() {
  ...
  const playerClasses: Record<number, string> = {
  ...
  const simulatedProfiles = [
    ...
    { name: 'Sofia', commander: 'Yuriko, the Tiger\'s Shadow', colors: ['U', 'B'] },
    { name: 'Tomás', commander: 'Prossh, Skyraider of Kher', colors: ['B', 'R', 'G'] },
    { name: 'Rita', commander: 'Lathril, Blade of the Elves', colors: ['B', 'G'] }
  ];
  ...
  const simulatePlayerJoin = () => {
    ...
    const newSimIndex = simIndex + 1;
    setSimIndex(newSimIndex);
    ...
    showToastMessage(`${profile.name} joined as Player ${joinSlot}!`);
  };
  ...
  const updateCounters = (playerNum: number, type: 'poison' | 'experience' | 'energy', delta: number) => {
    setCounters(prev => ({
      ...
      [playerNum]: {
        ...prev[playerNum],
        [type]: Math.max(0, prev[playerNum][type] + delta)
      }
    }));
  };
    ...
    <div className="app">
      <style dangerouslySetInnerHTML={{ __html: `
        * { margin: 0; padding: 0; box-sizing: border-box; -webkit-tap-highlight-color: transparent; }
        ...
        .tile-qr { display: none; flex-direction: column; align-items: center; justify-content: center; width: 100%; height: 100%; gap: 4px; }
        ...
        .join-modal-title {
          font-weight: 600; font-size: 16px; color: rgb(44,62,54);
          margin-bottom: 4px; text-align: left;
        }

        .join-modal-subtitle {
          font-size: 12px; color: rgb(90,110,98);
          margin-bottom: 16px;
        }
        ...
        .nav-item:active .dice-icon { border-color: rgb(245,239,227); }
        .nav-item:active .dice-dot { background: rgb(245,239,227); }
        .nav-item:active .star-icon { border-color: rgb(245,239,227); }
        .nav-item:active .star { background: rgb(245,239,227); }
        .nav-item:active .nav-label { color: rgb(245,239,227); }

        .nav-icon { width: 24px; height: 24px; display: flex; align-items: center; justify-content: center; }

        .dice-icon {
          width: 24px; height: 24px;
          border: 1.75px solid rgb(90,110,98); border-radius: 4px;
          position: relative;
          transition: border-color 0.2s ease;
        }

        .dice-dot {
          width: 3px; height: 3px; background: rgb(90,110,98);
        ...
        .star-icon {
          width: 24px; height: 24px;
          border: 1.75px solid rgb(90,110,98); border-radius: 50%;
          display: flex; align-items: center; justify-content: center;
          transition: border-color 0.2s ease;
        }
        ...
        .nav-label {
          font-weight: 500; font-size: 12px; color: rgb(90,110,98);
          max-height: 18px;
          opacity: 1;
          overflow: hidden;
        ...
        .list-icon span {
          height: 1.5px; background: rgb(90,110,98); border-radius: 1px;
          transition: background 0.2s ease;
        }
          ...
          >
            <div className="counters-modal">
              ...
              <div className="player-selector">
                {[1, 2, 3, 4, 5].map(num => {
                  const p = players[num];
                  let bgColor = 'rgb(222,212,192)';
                  let borderColor = 'rgb(184,168,138)';
                  let textColor = 'rgb(90,110,98)';
              ...
              <div className="counter-row">
                <div className="counter-label">
                  <div className="counter-icon">
                    <svg viewBox="0 0 23 23" fill="none">
                      <path
                        d="M11.3 15.8455C16.8228 15.8455 21.3 12.5894 21.3 8.57278C21.3 4.55616 16.8228 1.30005 11.3 1.30005C5.77714 1.30005 1.29999 4.55616 1.29999 8.57278C1.29999 12.5894 5.77714 15.8455 11.3 15.8455Z"
                        stroke="#2C3E36"
                        strokeWidth="2.6"
                        strokeLinecap="round"
                      ...
                      />
                      <path
                        d="M7.54999 6.75453L3.79999 3.11816M15.05 6.75453L18.8 3.11816M11.3 15.8454V21.3M6.29999 19.4818H16.3"
                        stroke="#2C3E36"
                        strokeWidth="2.4"
                        strokeLinecap="round"
                        strokeLinejoin="round"
              ...
              <div className="counter-row">
                <div className="counter-label">
                  <div className="counter-icon">
                    <svg viewBox="0 0 23 23" fill="none">
                      <path
                        d="M1.30002 21.3L2.96668 5.74449L7.13335 12.4112L11.3 1.30005L15.4667 12.4112L19.6334 5.74449L21.3 21.3H1.30002Z"
                        stroke="#2C3E36"
                        strokeWidth="2.6"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                      />
                      <path d="M1.30002 21.3H21.3" stroke="#2C3E36" strokeWidth="2.6" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                  </div>
              ...
              <div className="counter-row">
                <div className="counter-label">
                  <div className="counter-icon">
                    <svg viewBox="0 0 23 23" fill="none">
                      <path
                        d="M13.8 1.30005L1.30005 12.7286H11.3L8.80005 21.3L21.3 9.87148H11.3L13.8 1.30005Z"
                        stroke="#2C3E36"
                        strokeWidth="2.6"
                        strokeLinecap="round"
                        strokeLinejoin="round"
      ...
      {joinModalOpen && joinSlot && (
        <div className="join-modal active" onClick={closeJoinModal}>
          <div className="join-modal-card" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="join-slot-code">
              <span>SLOT-{joinSlot}-ARC7</span>
            </div>
            <button className="join-simulate-btn" onClick={simulatePlayerJoin}>
